...
class MitarbeitersControllerTest < ActionController::TestCase
  ...
  test "should create mitarbeiter" do
    assert_difference('Mitarbeiter.count') do
      post :create, mitarbeiter: { az_konto: @mitarbeiter.az_konto, az_monat: @mitarbeiter.az_monat, festnetz: @mitarbeiter.festnetz, handy: @mitarbeiter.handy, nachname: @mitarbeiter.nachname, pesonalnummer: @mitarbeiter.pesonalnummer, vorname: @mitarbeiter.vorname }
    end
  ...
  test "should update mitarbeiter" do
    patch :update, id: @mitarbeiter, mitarbeiter: { az_konto: @mitarbeiter.az_konto, az_monat: @mitarbeiter.az_monat, festnetz: @mitarbeiter.festnetz, handy: @mitarbeiter.handy, nachname: @mitarbeiter.nachname, pesonalnummer: @mitarbeiter.pesonalnummer, vorname: @mitarbeiter.vorname }
    assert_redirected_to mitarbeiter_path(assigns(:mitarbeiter))
  end
